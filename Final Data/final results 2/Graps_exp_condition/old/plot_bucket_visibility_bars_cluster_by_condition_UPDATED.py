...
OUTPUT_FILE = "Final Data/final results 2/combined/plot_visibility_dis_cluster_bars_by_condition.png"
OUTPUT_STATS = "Final Data/final results 2/combined/plot_visibility_dis_cluster_stats_by_condition.csv"
OUTPUT_TABLE = "Final Data/final results 2/combined/plot_visibility_dis_cluster_table.xlsx"
INPUT_TOTAL = 50
...
def aggregate_by_condition(df: pd.DataFrame, bucket: str) -> pd.DataFrame:
    ...
    grouped = (
        sub.groupby(["model", "experiment_condition"])
